...
export default function Header() {
  const { loggedIn, user, logout, favorites, watchlist } = useApp();
              ...
              {showMenu && (
                <>
                  ...
                  <div className="profileMenu">
                    ...
                    <button className="menuItem" onClick={() => goTo("/watchlist")}>
                      📋 Watchlist
                      {watchlist.length > 0 && (
                        <span className="menuBadge">{watchlist.length}</span>
                      )}
                    </button>
        ...
        <nav className="mobileNav">
          ...
          {loggedIn && (
            <>
              ...
              <NavLink to="/watchlist" className={navClass} onClick={() => setMobileOpen(false)}>📋 Watchlist</NavLink>
